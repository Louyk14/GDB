...
GraphDBParser::ValueContext* GraphDBParser::value() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 82) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 82)) & ((1ULL << (GraphDBParser::INTEGER_NUMBER - 82))
      | (1ULL << (GraphDBParser::NOT_INTEGER_NUMBER - 82))
      | (1ULL << (GraphDBParser::TEXT - 82)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
tree::TerminalNode* GraphDBParser::FuncNameContext::K_track() {
  return getToken(GraphDBParser::K_track, 0);
}
...
GraphDBParser::FuncNameContext* GraphDBParser::funcName() {
  ...
  try {
    ...
    if (!(((((_la - 50) & ~ 0x3fULL) == 0) &&
      ...
      | (1ULL << (GraphDBParser::K_tdensesub - 50))
      | (1ULL << (GraphDBParser::K_track - 50)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
GraphDBParser::DataTypeContext* GraphDBParser::dataType() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 72) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 72)) & ((1ULL << (GraphDBParser::K_int - 72))
      | (1ULL << (GraphDBParser::K_integer - 72))
      | (1ULL << (GraphDBParser::K_float - 72))
      | (1ULL << (GraphDBParser::K_double - 72))
      | (1ULL << (GraphDBParser::K_char - 72))
      | (1ULL << (GraphDBParser::K_string - 72)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
GraphDBParser::ParaItemContext* GraphDBParser::paraItem() {
  ...
  try {
    ...
    if (!(((((_la - 82) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 82)) & ((1ULL << (GraphDBParser::INTEGER_NUMBER - 82))
      | (1ULL << (GraphDBParser::NOT_INTEGER_NUMBER - 82))
      | (1ULL << (GraphDBParser::NAME_STRING - 82))
      | (1ULL << (GraphDBParser::TEXT - 82)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
...
std::vector<std::string> GraphDBParser::_symbolicNames = {
  ...
  "K_inducedsub", "K_connect", "K_clique", "K_tdensesub", "K_track", "K_create", 
  "K_int", "K_integer", "K_float", "K_double", "K_char", "K_string", "K_true", 
  "K_false", "K_file", "K_load", "INTEGER_NUMBER", "NOT_INTEGER_NUMBER", 
  "NAME_STRING", "LETTER", "SYMBOL", "CHAR", "TEXT"
};
...
GraphDBParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x5a, 0x3e9, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 
    ...
    0x2, 0x9, 0x5, 0x2, 0xe, 0xe, 0x30, 0x30, 0x32, 0x32, 0x4, 0x2, 0x54, 
    0x55, 0x5a, 0x5a, 0x4, 0x2, 0xe, 0xf, 0x13, 0x14, 0x3, 0x2, 0x36, 0x38, 
    0x4, 0x2, 0x34, 0x35, 0x3c, 0x48, 0x3, 0x2, 0x4a, 0x4f, 0x4, 0x2, 0x54, 
    0x56, 0x5a, 0x5a, 0x2, 0x3d8, 0x2, 0xe6, 0x3, 0x2, 0x2, 0x2, 0x4, 0xec, 
    ...
    0x2, 0x104, 0x105, 0x7, 0x1c, 0x2, 0x2, 0x105, 0x106, 0x7, 0x52, 0x2, 
    ...
    0x2, 0x2, 0x135, 0x136, 0x7, 0x52, 0x2, 0x2, 0x136, 0x137, 0x5, 0x44, 
    ...
    0x7, 0x17, 0x2, 0x2, 0x22d, 0x22e, 0x7, 0x52, 0x2, 0x2, 0x22e, 0x230, 
    ...
